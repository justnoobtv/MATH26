...
public class Easy_Question13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question13);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q20_Easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question13.this,Easy_Question14.class);
                startActivity(i);
            }
        });
    }
