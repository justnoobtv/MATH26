...
public class Easy_Question14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question14);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q21_Easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question14.this,Easy_Question15.class);
                startActivity(i);
            }
        });
    }
