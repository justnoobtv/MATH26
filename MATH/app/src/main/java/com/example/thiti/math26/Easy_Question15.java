...
public class Easy_Question15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question15);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q22_Easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question15.this,Easy_Question16.class);
                startActivity(i);
            }
        });
    }
