...
public class Easy_Question18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question18);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q27_Easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question18.this,Easy_Question19.class);
                startActivity(i);
            }
        });
    }
