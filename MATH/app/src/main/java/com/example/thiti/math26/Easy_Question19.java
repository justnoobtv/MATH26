...
public class Easy_Question19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question19);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q28_Easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question19.this,Easy_Question20.class);
                startActivity(i);
            }
        });
    }
