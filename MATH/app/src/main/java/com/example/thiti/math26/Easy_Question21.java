...
public class Easy_Question21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question21);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q30_Easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question21.this,Easy_Question22.class);
                startActivity(i);
            }
        });
    }
