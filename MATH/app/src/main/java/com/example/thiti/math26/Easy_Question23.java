...
public class Easy_Question23 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question23);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q32_Easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question23.this,Easy_Question24.class);
                startActivity(i);
            }
        });
    }
