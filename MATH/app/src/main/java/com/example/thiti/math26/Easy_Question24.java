...
public class Easy_Question24 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question24);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q34_Easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question24.this,Easy_Question25.class);
                startActivity(i);
            }
        });
    }
