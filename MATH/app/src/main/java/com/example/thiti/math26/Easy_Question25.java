...
public class Easy_Question25 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question25);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q35_Easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question25.this,Easy_Question26.class);
                startActivity(i);
            }
        });
    }
