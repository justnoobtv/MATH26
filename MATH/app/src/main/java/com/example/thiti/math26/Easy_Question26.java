...
public class Easy_Question26 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question26);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q36_Easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question26.this,Easy_Hamster_Edit.class);
                startActivity(i);
            }
        });
    }
