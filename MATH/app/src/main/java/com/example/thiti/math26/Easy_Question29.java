...
public class Easy_Question29 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question29);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q44_Easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question29.this,Easy_Question30.class);
                startActivity(i);
            }
        });
    }
