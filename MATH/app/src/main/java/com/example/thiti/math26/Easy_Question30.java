...
public class Easy_Question30 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question30);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q45_Easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question30.this,Easy_Question31.class);
                startActivity(i);
            }
        });
    }
