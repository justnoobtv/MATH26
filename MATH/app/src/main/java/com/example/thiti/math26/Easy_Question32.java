...
public class Easy_Question32 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question32);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q48_Easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question32.this,Easy_Question33.class);
                startActivity(i);
            }
        });
    }
