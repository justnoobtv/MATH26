...
public class Easy_Question33 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question33);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q49_Easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question33.this,Easy_Question34.class);
                startActivity(i);
            }
        });
    }
