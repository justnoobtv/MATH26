...
public class Easy_Question34 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question34);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q51_Easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question34.this,Easy_Question35.class);
                startActivity(i);
            }
        });
    }
