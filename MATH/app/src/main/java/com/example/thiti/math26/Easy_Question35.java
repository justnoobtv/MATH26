...
public class Easy_Question35 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question35);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q55_Easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question35.this,Easy_Question36.class);
                startActivity(i);
            }
        });
