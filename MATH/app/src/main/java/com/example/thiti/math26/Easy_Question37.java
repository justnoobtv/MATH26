...
public class Easy_Question37 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question37);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q65_easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question37.this,Easy_Question36.class);
                startActivity(i);
            }
        });
    }
