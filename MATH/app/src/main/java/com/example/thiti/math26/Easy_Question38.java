...
public class Easy_Question38 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question38);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q66_easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question38.this,Easy_Question39.class);
                startActivity(i);
            }
        });
    }
