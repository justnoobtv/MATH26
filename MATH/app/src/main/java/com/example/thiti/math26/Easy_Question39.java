...
public class Easy_Question39 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q67_easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question39.this,Easy_Question40.class);
                startActivity(i);
            }
        });
    }
