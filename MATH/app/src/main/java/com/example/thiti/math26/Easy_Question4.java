...
public class Easy_Question4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question4);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q6");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question4.this,Easy_Question5.class);
                startActivity(i);
            }
        });
    }
    ...
    public void dialogshow(){
        AlertDialog.Builder ImageDialog = new AlertDialog.Builder(Easy_Question4.this);
        ImageDialog.setTitle("Correct");
        ImageView showImage = new ImageView(Easy_Question4.this);
