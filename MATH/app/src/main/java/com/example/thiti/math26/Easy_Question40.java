...
public class Easy_Question40 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question40);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q70_easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question40.this,Easy_Question41.class);
                startActivity(i);
            }
        });
    }
