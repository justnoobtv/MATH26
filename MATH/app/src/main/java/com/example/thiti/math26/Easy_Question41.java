...
public class Easy_Question41 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question41);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q71_easy");
    ...
    public void Confirm(View v) {
        ...
        if (Answer5 == InputNumber4){
            AlertDialog.Builder alertadd = new AlertDialog.Builder(Easy_Question41.this);
            alertadd.setTitle("Correct");
            LayoutInflater factory = LayoutInflater.from(Easy_Question41.this);
            final View view = factory.inflate(R.layout.alert_box, null);
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question41.this,Easy_Question39.class);
                startActivity(i);
            }
        });
    }
