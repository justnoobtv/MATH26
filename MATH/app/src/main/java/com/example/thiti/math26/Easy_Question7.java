...
public class Easy_Question7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy__question7);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q13_Easy");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Easy_Question7.this,Easy_Question8.class);
                startActivity(i);
            }
        });
    }
    ...
    public void dialogshow(){
        AlertDialog.Builder ImageDialog = new AlertDialog.Builder(Easy_Question7.this);
        ImageDialog.setTitle("Correct");
        ImageView showImage = new ImageView(Easy_Question7.this);
