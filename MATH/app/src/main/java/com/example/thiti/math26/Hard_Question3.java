...
public class Hard_Question3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard__question3);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q50_Hard");
    ...
    public void Confirm(View v) {
        ...
        if (Answer6 == InputNumber2) {
            dialogshow();
        }
        if (Answer6 == InputNumber3) {
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Hard_Question3.this,Hard_Question3.class);
                startActivity(i);
            }
        });
    }
    ...
    public void dialogshow(){
        AlertDialog.Builder ImageDialog = new AlertDialog.Builder(Hard_Question3.this);
        ImageDialog.setTitle("Correct");
        ImageView showImage = new ImageView(Hard_Question3.this);
        showImage.setImageResource(R.drawable.macaque);
