...
public class Hard_Question5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard__question5);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q61_hard");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Hard_Question5.this, Hard_Question5.class);
                startActivity(i);
            }
        });
    }
    ...
    public void dialogshow(){
        AlertDialog.Builder ImageDialog = new AlertDialog.Builder(Hard_Question5.this);
        ImageDialog.setTitle("Correct");
        ImageView showImage = new ImageView(Hard_Question5.this);
        showImage.setImageResource(R.drawable.antelope);
