...
public class Normal_Question5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_normal__question5);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q11_Medium");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Normal_Question5.this, Normal_Question6.class);
                startActivity(i);
            }
        });
    }
    ...
    public void dialogshow(){
        AlertDialog.Builder ImageDialog = new AlertDialog.Builder(Normal_Question5.this);
        ImageDialog.setTitle("Correct");
        ImageView showImage = new ImageView(Normal_Question5.this);
        showImage.setImageResource(R.drawable.butterfly);
