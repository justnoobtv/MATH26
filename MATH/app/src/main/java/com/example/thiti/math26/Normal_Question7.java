...
public class Normal_Question7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_normal__question7);
        ...
        myFirebase = new Firebase("https://project-7787971703206926875.firebaseio.com/Q18_Medium");
    ...
    public void Next(View v) {
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Normal_Question7.this, Normal_Question8.class);
                startActivity(i);
            }
        });
    }
    ...
    public void dialogshow(){
        AlertDialog.Builder ImageDialog = new AlertDialog.Builder(Normal_Question7.this);
        ImageDialog.setTitle("Correct");
        ImageView showImage = new ImageView(Normal_Question7.this);
        showImage.setImageResource(R.drawable.crocodile);
